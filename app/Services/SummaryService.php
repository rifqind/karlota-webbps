...
{
    public function setupCategory($dataset_before, $dataset, $region)
    {
    ...
    public function setupSector($dataset_before, $dataset, $region)
    {
        ...
        foreach ($sector as $keySet => $set) {
            ...
            if ($set == \App\Models\Sector::EKSPOR_IMPOR_ID) {
                $importId = [\App\Models\Subsector::IMPOR_ID];
    ...
    public function setupSubsector($dataset_before, $dataset, $region)
    {
    ...
    public function setupTotal($lapus_before, $lapus, $peng_before, $peng, $region)
    {
        // lapus
    ...
    public function buildValue($past, $present, $presentObject, $type, $typeAttribute)
    {
        $qtoq = 0;
        $yony = 0;
        $ctoc = 0;
    ...
    public function buildTotal($past, $present, $presentObject)
    {
        $qtoq = 0;
        $yony = 0;
        $ctoc = 0;
